    ...
    command: state => (args, p) => {
        ...
        say(
            '<b>' +
                B.center(
                    60,
                    `${p.name}, level ${p.level} ${p.playerClass.config.name}`,
                    'green'
                )
        );
        ...
        say('<b><green>' + sprintf('%36s', 'Weapon '));
        ...
        say('<b><green>' + sprintf('%-24s', ' Stats') + '</green></b>');
        say('.' + B.line(22) + '.');
