        ...
        useAbility: state =>
            function(ability, args) {
                ...
                if (!this.playerClass.canUseAbility(this, ability.id)) {
                    return B.sayAt(
                        this,
                        'You have not yet learned that ability.'
                    );
                }
                    ...
                    if (!args || !args.length) {
                        ...
                        try {
                            ...
                            if (
                                ...
                                e instanceof
                                    CombatErrors.CombatInvalidTargetError ||
                ...
                try {
                    ...
                    if (e instanceof SkillErrors.CooldownError) {
                        ...
                        return B.sayAt(
                            this,
                            `${ability.name} is on cooldown. ${humanize(
                                e.effect.remaining
                            )} remaining.`
                        );
                    }
        ...
        level: state =>
            function() {
                ...
                for (const abilityId of newSkills) {
                    ...
                    B.sayAt(
                        this,
                        `<bold><yellow>You can now use skill: ${
                            skill.name
                        }.</yellow></bold>`
                    );
                    skill.activate(this);
                ...
                for (const abilityId of newSpells) {
                    ...
                    B.sayAt(
                        this,
                        `<bold><yellow>You can now use spell: ${
                            spell.name
                        }.</yellow></bold>`
                    );
                }
