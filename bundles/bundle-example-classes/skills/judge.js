...
module.exports = {
    ...
    run: state =>
        function(args, player, target) {
            ...
            Broadcast.sayAt(
                player,
                `<b><yellow>Concentrated holy energy slams into ${
                    target.name
                }!</yellow></b>`
            );
            Broadcast.sayAtExcept(
                ...
                `<b><yellow>${
                    player.name
                } conjures concentrated holy energy and slams it into ${
                    target.name
                }!</yellow></b>`,
                [target, player]
            );
            Broadcast.sayAt(
                ...
                `<b><yellow>${
                    player.name
                } conjures concentrated holy energy and slams it into you!</yellow></b>`
            );
