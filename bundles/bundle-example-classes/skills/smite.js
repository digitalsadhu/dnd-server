...
module.exports = {
    ...
    run: state =>
        function(args, player, target) {
            ...
            const amount =
                Combat.calculateWeaponDamage(player) * (damagePercent / 100);
            ...
            Broadcast.sayAt(
                player,
                `<b><yellow>Your weapon radiates holy energy and you strike ${
                    target.name
                }!</yellow></b>`
            );
            Broadcast.sayAtExcept(
                ...
                `<b><yellow>${
                    player.name
                }'s weapon radiates holy energy and they strike ${
                    target.name
                }!</yellow></b>`,
                [target, player]
            );
            Broadcast.sayAt(
                ...
                `<b><yellow>${
                    player.name
                }'s weapon radiates holy energy and they strike you!</yellow></b>`
            );
